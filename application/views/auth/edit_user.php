	...
	<div class="col-md-9 col-sm-12 dashboard">
		...
		<div class="col-md-4 text-right text-success"><span class="afigure">
				<span
					...
					style="font-size:0.8em"><span style="font-size: 0.8em;color: forestgreen;font-weight: 600">Rs</span></span></span></div>
		<div class="col-md-8">
		...
		$(".cred").blur((e) => {
			...
			$.post("<?php echo site_url()?>/auth/checkCredentional", {
				...
				if (data === "success") {
					...
					$("#logError").text("Click the WithDraw button and the amount will be sent to you soon").attr("class", "logEr bg bg-success");
				}
				else {
